  ...
  <el-card class="boxcard">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template>
            <el-row >
                <el-button plain @click="showUpdataUserMsgBox()" size="mini" type="primary" icon="el-icon-edit" circle></el-button>
                <el-button plain  size="mini" type="success" icon="el-icon-check" circle></el-button>
                <el-button plain @click="showDeleUserMsgBox()" size="mini" type="danger" icon="el-icon-delete" circle></el-button>
            </el-row>
        </template>
      </el-table-column>
    </el-table>
