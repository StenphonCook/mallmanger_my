  ...
  <el-card class="boxcard">
    ...
    <el-form :model="form">
        ...
        <el-form-item label="角色" label-width="100px">
            ...
            <!-- 弱国select的绑定的数据的值和option的value一样 就会显示该option的lable值 -->
        <el-select v-model="item" placeholder="请选择活动区域">
            <el-option label="请选择" :value="-1"></el-option>
            <!-- <el-option v-for="(item, i) in items" :key="i" label="item" value="i"></el-option> -->
        </el-select>
        ...
        methods: {
           ...
           async addUser(){
            ...
            async showSetRoleDia(user){
                this.showSetRoleDia = true
                const res = this.$http.put(`users/${user.id}/role`)
                console.log(res)
            }
        },
    }
